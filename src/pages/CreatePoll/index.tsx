...
class CreateProposal {
  // @ts-ignore
  constructor(cid, exp_time, chain_id, proposal_type) {
    // @ts-ignore
    this.cid = cid;
    // @ts-ignore
...
const CreatePoll = () => {
  ...
  // const proposalAccount  = new PublicKey('3XKoxvhWnkNbtkdMNQR85yiiuscgYiEDVRML9XmY6YEF');
  ...
  const createVotingApi = async () => {
    ...
    try {
      const instructionData = new CreateProposal('your_cid', 1234567890, 1234567890, 1);
